odoo.define('product_line_control.products_searchbar_garden', function (require) {
'use strict';
...
publicWidget.registry.productsSearchBar = publicWidget.Widget.extend({
    selector: '.o_wsale_products_searchbar_form_garden',
    xmlDependencies: ['/product_line_control/static/src/xml/search.xml'],
    events: {
